...
for (file in c("test-services.R", "test-service-contracts.R", "test-jobs.R", "test-qualitative.R", "test-communications.R", "test-authentication.R", "test-reporting.R", "test-protocols.R", "test-panel-import.R", "test-participation.R", "test-invitations.R", "test-languages.R")) {
