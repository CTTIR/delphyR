...
tryCatch({
  ...
  tryCatch({
    ...
    cat('EMPTY MIGRATION PASS: six migrations, idempotent rerun, synthetic service fixture.\n')
  },finally=DBI::dbDisconnect(r$con))
},finally={DBI::dbExecute(admin,paste('DROP DATABASE',quoted));DBI::dbDisconnect(admin)})
