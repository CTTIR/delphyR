...
- Services prüfen Rechte, Studienzugehörigkeit und Zustände; bestätigte Saves brauchen einen Commit.
- Analytik unabhängig von Shiny; PostgreSQL ist das maßgebliche Backend.
- Testnachweise und offene P1-Gates ehrlich in docs/IMPLEMENTATION_STATUS.md führen.
- admin/ bleibt lokal und ignoriert. Keine Secrets oder lokale Bibliotheken committen.
